...
const config = {
  ...
  formFields: [
    ...
    { key: 'impugnedOrder', label: 'Impugned Order Summary', placeholder: 'Summary of the order being challenged', type: 'textarea' as const },
    { key: 'grounds', label: 'Grounds', placeholder: 'Grounds for the petition...', type: 'textarea' as const },
    { key: 'facts', label: 'Relevant Facts', placeholder: 'Brief facts', type: 'textarea' as const },
