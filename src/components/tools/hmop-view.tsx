...
const config = {
  ...
  formFields: [
    ...
    { key: 'marriageDate', label: 'Date of Marriage', placeholder: '', type: 'date', half: true },
    ...
    { key: 'grounds', label: 'Grounds for Divorce', placeholder: 'Cruelty, desertion, adultery, mutual consent, irretrievable breakdown...', type: 'textarea' },
    { key: 'facts', label: 'Material Facts', placeholder: 'Detailed facts and circumstances...', type: 'textarea' },
    { key: 'reliefSought', label: 'Relief Sought', placeholder: 'e.g., Divorce, custody, maintenance, alimony', type: 'textarea' },
  ],
