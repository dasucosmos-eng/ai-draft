...
const config = {
  ...
  formFields: [
    ...
    { key: 'decreeAmount', label: 'Decree Amount (₹)', placeholder: 'Amount of decree', type: 'number', half: true },
    { key: 'grounds', label: 'Grounds for Arrest', placeholder: 'Why civil arrest is needed - hiding assets, non-cooperation...', type: 'textarea' },
    { key: 'debtorAddress', label: 'Debtor Address', placeholder: 'Last known address of the debtor', type: 'textarea' },
    { key: 'prayer', label: 'Prayer', placeholder: 'Specific prayer for arrest warrant', type: 'textarea' },
  ],
