...
const config = {
  ...
  formFields: [
    ...
    { key: 'convictionDate', label: 'Date of Conviction', placeholder: '', type: 'date', half: true },
    ...
    { key: 'grounds', label: 'Grounds for Remission', placeholder: 'Good conduct, age, health, family circumstances...', type: 'textarea' },
    { key: 'behavior', label: 'Prison Conduct', placeholder: 'Details of good behavior, rehabilitation efforts', type: 'textarea' },
