...
exports.GOOGLE_SEARCH_COST_PER_QUERY = void 0;
exports.searchLegal = searchLegal;
exports.searchCaseLaw = searchCaseLaw;
exports.searchStatutes = searchStatutes;
exports.fetchUrlContent = fetchUrlContent;
exports.fetchUrlContentLegacy = fetchUrlContentLegacy;
exports.enrichSearchResults = enrichSearchResults;
exports.googleSearchHealthCheck = googleSearchHealthCheck;
 ...
 */
async function searchLegal(query, numResults = 7) {
 ...
 */
async function searchViaJsonApi(query, numResults, apiKey, cseId) {
 ...
 */
async function searchCaseLaw(query, numResults = 7) {
    return searchLegal(query, numResults);
}
/**
 * Search specifically for statutes, bare acts, and legislation
 */
async function searchStatutes(query, numResults = 5) {
    return searchLegal(query, numResults);
}
 ...
 */
async function fetchUrlContentLegacy(url) {
 ...
 */
function extractLegalPageContent(html, url) {
 ...
 */
async function enrichSearchResults(results, query, topN = 3) {
...
// --- Internal Parsers ---
function parseJsonResponse(data, query, searchTime) {
...
function parseSourceFromLink(displayLink) {
...
exports.GOOGLE_SEARCH_COST_PER_QUERY = 0.005;
// --- Health Check ---
async function googleSearchHealthCheck() {
    try {
