...
const config = {
  ...
  formFields: [
    ...
    { key: 'amountDecreed', label: 'Amount Decreed (₹)', placeholder: 'Total amount', type: 'number', half: true },
    { key: 'amountDue', label: 'Amount Due (₹)', placeholder: 'Amount still outstanding', type: 'number', half: true },
    { key: 'decreeSummary', label: 'Decree Summary', placeholder: 'Summary of the decree terms...', type: 'textarea' },
    { key: 'executionDetails', label: 'Execution Details', placeholder: 'Mode of execution, assets, properties...', type: 'textarea' },
    { key: 'grounds', label: 'Grounds', placeholder: 'Why execution is needed now', type: 'textarea' },
  ],
