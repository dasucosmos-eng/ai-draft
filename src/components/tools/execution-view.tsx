...
const config = {
  ...
  formFields: [
    ...
    { key: 'amount', label: 'Amount (₹)', placeholder: 'Decree amount', type: 'number', half: true },
    { key: 'decreeDate', label: 'Decree Date', placeholder: '', type: 'date', half: true },
    { key: 'facts', label: 'Description', placeholder: 'Describe the decree and what execution is needed...', type: 'textarea' },
    { key: 'reliefSought', label: 'Execution Relief', placeholder: 'What execution relief is sought?', type: 'textarea' },
  ],
