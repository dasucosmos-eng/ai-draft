...
exports.apiExtractText = void 0;
const v2_1 = require("firebase-functions/v2");
const cors_1 = __importDefault(require("cors"));
const ocr_1 = require("./ocr");
const corsHandler = (0, cors_1.default)({ origin: true });
exports.apiExtractText = v2_1.https.onRequest({ timeoutSeconds: 60, secrets: [] }, async (req, res) => {
        ...
        try {
            ...
            for (const part of parts) {
                ...
                if (["txt", "md", "csv", "json", "xml", "html", "htm"].includes(ext)) {
                    ...
                    try {
                        text = await (0, ocr_1.extractTextFromBuffer)(fileBuffer);
                    }
                    catch (ocrErr) {
