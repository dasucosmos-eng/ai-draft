...
const config = {
  ...
  formFields: [
    ...
    { key: 'arrestDate', label: 'Date of Arrest', placeholder: '', type: 'date', half: true },
    { key: 'grounds', label: 'Grounds for Bail', placeholder: 'Why bail should be granted - no criminal history, no tampering, etc.', type: 'textarea' },
    { key: 'facts', label: 'Case Facts', placeholder: 'Brief facts of the case', type: 'textarea' },
    { key: 'sureties', label: 'Surety Details', placeholder: 'Number and details of proposed sureties', type: 'textarea' },
  ],
