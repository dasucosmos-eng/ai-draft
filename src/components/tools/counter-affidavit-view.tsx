...
const config = {
  ...
  formFields: [
    ...
    { key: 'originalRelief', label: 'Original Relief Sought', placeholder: 'What the petitioner originally sought', type: 'textarea' as const },
    { key: 'rejectionGrounds', label: 'Grounds for Rejection', placeholder: 'Why the original petition/affidavit should be opposed', type: 'textarea' as const },
    { key: 'facts', label: 'Counter Facts', placeholder: 'Factual rebuttal of the claims made in the original affidavit', type: 'textarea' as const },
    { key: 'supportingDocuments', label: 'Supporting Documents', placeholder: 'List documents attached in support', type: 'textarea' as const },
  ],
