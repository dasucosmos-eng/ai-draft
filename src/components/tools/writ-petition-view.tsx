...
const config = {
  ...
  formFields: [
    ...
    { key: 'impugnedOrder', label: 'Impugned Action/Order', placeholder: 'What action or order is being challenged', type: 'textarea' as const },
    { key: 'grounds', label: 'Grounds for Writ', placeholder: 'Constitutional violation, illegality, procedural impropriety...', type: 'textarea' as const },
    { key: 'facts', label: 'Relevant Facts', placeholder: 'Detailed facts leading to the writ', type: 'textarea' as const },
    { key: 'fundamentalRights', label: 'Fundamental Rights Violated', placeholder: 'e.g., Article 21, Article 14, Article 19...', type: 'textarea' as const },
    { key: 'prayer', label: 'Prayer / Relief Sought', placeholder: 'Specific writ relief sought', type: 'textarea' as const },
  ],
