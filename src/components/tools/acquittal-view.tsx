...
const config = {
  ...
  formFields: [
    ...
    { key: 'prosecutionCase', label: 'Prosecution Case Summary', placeholder: 'Summary of prosecution evidence and arguments', type: 'textarea' },
    { key: 'defenseArguments', label: 'Defense Arguments', placeholder: 'Why the accused should be acquitted...', type: 'textarea' },
    { key: 'witnesses', label: 'Witness Analysis', placeholder: 'Analysis of prosecution witnesses and their statements', type: 'textarea' },
    { key: 'evidence', label: 'Evidence Analysis', placeholder: 'Documentary/circumstantial evidence analysis', type: 'textarea' },
  ],
