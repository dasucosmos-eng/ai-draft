...
exports.apiRazorpayVerify = exports.apiRazorpayCreateOrder = void 0;
 ...
 */
exports.apiRazorpayCreateOrder = v2_1.https.onRequest({
    timeoutSeconds: 30,
    region: "us-central1",
    secrets: [...secrets_1.aiFunctionSecrets, "RAZORPAY_KEY_ID", "RAZORPAY_KEY_SECRET"],
}, async (req, res) => {
 ...
 */
exports.apiRazorpayVerify = v2_1.https.onRequest({
    timeoutSeconds: 30,
    region: "us-central1",
    secrets: [...secrets_1.aiFunctionSecrets, "RAZORPAY_KEY_ID", "RAZORPAY_KEY_SECRET"],
}, async (req, res) => {
    return corsHandler(req, res, async () => {
        ...
        try {
            const { razorpay_order_id, razorpay_payment_id, razorpay_signature, planId, billingCycle, userId, } = req.body;
            ...
            console.log(`[razorpay] Payment verified: ${razorpay_payment_id}, plan: ${planId}, amount: ${payment.amount}`);
