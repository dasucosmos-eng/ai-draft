...
const config = {
  ...
  formFields: [
    ...
    { key: 'deceasedDateOfDeath', label: 'Date of Death', placeholder: '', type: 'date', half: true },
    ...
    { key: 'otherHeirs', label: 'Other Legal Heirs', placeholder: 'Names and relationships of other surviving legal heirs', type: 'textarea' },
    { key: 'properties', label: 'Properties / Debts', placeholder: 'List of properties, bank accounts, debts of deceased...', type: 'textarea' },
    { key: 'facts', label: 'Relevant Facts', placeholder: 'When and how the deceased died, family details...', type: 'textarea' },
    { key: 'prayer', label: 'Prayer', placeholder: 'What is being sought', type: 'textarea' },
  ],
