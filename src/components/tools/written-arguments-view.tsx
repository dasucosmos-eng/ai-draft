...
const config = {
  ...
  formFields: [
    ...
    { key: 'issues', label: 'Issues for Determination', placeholder: 'List the key issues to be argued...', type: 'textarea' as const },
    { key: 'facts', label: 'Material Facts', placeholder: 'Brief facts of the case', type: 'textarea' as const },
    { key: 'arguments', label: 'Key Arguments', placeholder: 'Main arguments to be elaborated...', type: 'textarea' as const },
    { key: 'caseLaws', label: 'Case Laws / Precedents', placeholder: 'Relevant case laws to cite', type: 'textarea' as const },
    { key: 'conclusion', label: 'Prayer / Conclusion', placeholder: 'Summary and conclusion', type: 'textarea' as const },
  ],
