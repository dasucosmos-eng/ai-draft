...
const config = {
  ...
  formFields: [
    ...
    { key: 'facts', label: 'Facts for Injunction', placeholder: 'Why injunction is needed - urgency, irreparable harm...', type: 'textarea' },
    { key: 'grounds', label: 'Grounds', placeholder: 'Legal grounds for injunction...', type: 'textarea' },
    { key: 'prayer', label: 'Prayer / Relief Sought', placeholder: 'Specific injunction sought', type: 'textarea' },
  ],
