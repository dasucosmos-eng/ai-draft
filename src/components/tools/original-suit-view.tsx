...
const config = {
  ...
  formFields: [
    ...
    { key: 'causeOfAction', label: 'Cause of Action', placeholder: 'Brief description of the cause of action', type: 'textarea' },
    { key: 'matterFacts', label: 'Material Facts', placeholder: 'Describe the facts of the case in detail...', type: 'textarea' },
    ...
    { key: 'valuation', label: 'Valuation (₹)', placeholder: 'e.g., 500000', type: 'number', half: true },
  ],
