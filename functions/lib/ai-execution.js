        ...
        try {
            ...
            switch (task) {
                ...
                case "generateDocument": {
                    ...
                    const hasEAMode = eaModeHints.some((m) => req.body.mode === m || req.body.executionMode === m);
                    const hasEAStyleFields = req.body.applicantName || req.body.respondentName;
                ...
                case "generateEP": {
                    ...
                    const hasSomeDecreeInfo = decreeDetails.caseNumber ||
