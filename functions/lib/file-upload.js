...
async function getUserPlan(uid) {
    try {
        ...
        return user.customClaims?.plan || "free";
    }
    catch {
        return "free";
    }
...
exports.fileUploadUrl = v2_1.https.onRequest({ timeoutSeconds: 30, region: "us-central1", invoker: "public" }, async (req, res) => {
...
// ─── Delete file ───
exports.fileDelete = v2_1.https.onRequest({ timeoutSeconds: 15, region: "us-central1", invoker: "public" }, async (req, res) => {
    corsHandler(req, res, async () => {
        if (req.method !== "POST") {
            return res.status(405).json({ error: "Method not allowed" });
        }
...
// ─── List files ───
exports.fileList = v2_1.https.onRequest({ timeoutSeconds: 15, region: "us-central1", invoker: "public" }, async (req, res) => {
    corsHandler(req, res, async () => {
        if (req.method !== "POST") {
            return res.status(405).json({ error: "Method not allowed" });
        }
