...
const config = {
  ...
  formFields: [
    ...
    { key: 'prosecutionEvidence', label: 'Prosecution Evidence', placeholder: 'Summary of evidence against the accused', type: 'textarea' as const },
    { key: 'convictionArguments', label: 'Arguments for Conviction', placeholder: 'Why conviction is warranted...', type: 'textarea' as const },
    { key: 'sentencingArguments', label: 'Sentencing Arguments', placeholder: 'Appropriate sentence considering severity, precedent...', type: 'textarea' as const },
    { key: 'victimImpact', label: 'Victim Impact Statement', placeholder: 'Impact on victim / family', type: 'textarea' as const },
  ],
