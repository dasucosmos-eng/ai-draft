...
const config = {
  ...
  formFields: [
    ...
    { key: 'accidentDate', label: 'Date of Accident', placeholder: '', type: 'date', half: true },
    ...
    { key: 'injuries', label: 'Injuries / Fatalities', placeholder: 'Describe injuries sustained or death', type: 'textarea' },
    { key: 'facts', label: 'Accident Facts', placeholder: 'How the accident occurred...', type: 'textarea' },
    { key: 'claimAmount', label: 'Claim Amount (₹)', placeholder: 'Total compensation claimed', type: 'number' },
    { key: 'losses', label: 'Loss Details', placeholder: 'Medical expenses, loss of income, disability, funeral expenses...', type: 'textarea' },
  ],
