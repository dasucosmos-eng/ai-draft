...
const config = {
  ...
  formFields: [
    ...
    { key: 'valuation', label: 'Valuation', placeholder: 'Suit valuation (₹)', type: 'number' as const, half: true },
    { key: 'causeOfAction', label: 'Cause of Action', placeholder: 'When and how the cause of action arose...', type: 'textarea' as const },
    { key: 'facts', label: 'Case Facts', placeholder: 'Describe the facts of the case...', type: 'textarea' as const },
    { key: 'reliefSought', label: 'Relief Sought', placeholder: 'What relief do you seek from the court?', type: 'textarea' as const },
  ],
