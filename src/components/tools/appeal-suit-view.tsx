...
const config = {
  ...
  formFields: [
    ...
    { key: 'decreeDate', label: 'Decree/Order Date', placeholder: '', type: 'date', half: true },
    { key: 'suitNumber', label: 'Original Suit No.', placeholder: 'e.g., CS No. 456/2023', half: true },
    { key: 'impugnedOrder', label: 'Impugned Order Summary', placeholder: 'Summary of the order being appealed', type: 'textarea' },
    { key: 'groundsOfAppeal', label: 'Grounds of Appeal', placeholder: 'List the grounds for appeal...', type: 'textarea' },
    { key: 'facts', label: 'Relevant Facts', placeholder: 'Brief facts of the case', type: 'textarea' },
    { key: 'reliefSought', label: 'Relief Sought in Appeal', placeholder: 'What relief is sought', type: 'textarea' },
  ],
