...
const config = {
  ...
  formFields: [
    ...
    { key: 'decreeAmount', label: 'Decree Amount (₹)', placeholder: 'Amount', type: 'number', half: true },
    { key: 'propertyDetails', label: 'Property Details', placeholder: 'Address, type, registration details of property to be attached...', type: 'textarea' },
    { key: 'grounds', label: 'Grounds for Attachment', placeholder: 'Why attachment is needed...', type: 'textarea' },
    { key: 'prayer', label: 'Prayer', placeholder: 'Specific prayer for property attachment', type: 'textarea' },
  ],
