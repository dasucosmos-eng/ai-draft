...
const config = {
  ...
  formFields: [
    ...
    { key: 'grounds', label: 'Grounds for Guardianship', placeholder: 'Why guardianship is needed - death, incapacity, welfare of minor...', type: 'textarea' as const },
    { key: 'minorWelfare', label: 'Welfare Considerations', placeholder: 'How guardianship benefits the minor', type: 'textarea' as const },
    { key: 'financialStatus', label: 'Financial Status', placeholder: 'Petitioner income and financial capacity', type: 'textarea' as const },
