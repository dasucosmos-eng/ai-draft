...
export function normalizeDocumentCase(text: string): string {
 ...
 */
export function stripMarkdownFromData(data: any): any {
  if (!data || typeof data !== 'object') return data;
  if (Array.isArray(data)) return data.map(stripMarkdownFromData);
