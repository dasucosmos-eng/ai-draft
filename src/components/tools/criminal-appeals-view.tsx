...
const config = {
  ...
  formFields: [
    ...
    { key: 'convictionDate', label: 'Conviction/Order Date', placeholder: '', type: 'date', half: true },
    ...
    { key: 'impugnedOrder', label: 'Impugned Order Summary', placeholder: 'Summary of the judgment being appealed...', type: 'textarea' },
    { key: 'groundsOfAppeal', label: 'Grounds of Appeal', placeholder: 'Detailed grounds for appeal...', type: 'textarea' },
