...
const config = {
  ...
  formFields: [
    ...
    { key: 'assetDetails', label: 'Asset Details', placeholder: 'Details of assets to be attached/garnished...', type: 'textarea' as const },
    { key: 'grounds', label: 'Grounds for EA', placeholder: 'Why this execution application is needed...', type: 'textarea' as const },
